...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
    ...
    #print("~~~~~~~~~~~~~~~~~~In model _idx.shape: ", _idx.shape) # sk_debug
    #print("~~~~~~~~~~~~~~~~~~In model image.shape: ", image.shape) # sk_debug
    #print("~~~~~~~~~~~~~~~~~~In model np.sum(mask, axis=(1, 0)): ", np.sum(mask, axis=(1, 0))) # sk_debug
    mask = mask[:, :, _idx]
    #print("~~~~~~~~~~~~~~~~~~In model mask.shape: ", mask.shape) # sk_debug
    class_ids = class_ids[_idx]
    #print("~~~~~~~~~~~~~~~~~~In model class_ids: ", class_ids) # sk_debug
